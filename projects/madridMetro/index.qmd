...
The objective of this project was to design and implement a MySQL database that could, in theory, serve as the backbone of Madrid’s metro system—automatically handling ticket dispensing and decommissioning (upon expiration), calculating fare prices based on the client’s city zone and discount eligibility, and incorporating a detailed schema and features derived from a set of assumptions. 

<figure style="text-align: center;">
  <img src="icon.png" width="418" alt="Map of the Madrid metro lines">
  <figcaption>Map of the Madrid metro lines</figcaption>
</figure>
...
![](images/schema.png){.lightbox fig-align="center"}

### Enhanced Entity-Relationship (EER) Diagram

![](images/eerDiagram.png){.lightbox fig-align="center" }
...
- Implement automated logic based on given assumptions inside SQL 
- Manage complex client workflows in a high-traffic system
