...
-   Implemented **LLM-assisted annotation pipeline** with Gemini
-   Conducted **topic modeling (LDA)** and analyzed cross-topic sentiment trends
-   Interpreted outputs from **Hugging Face depression models** to connect loneliness with broader mental health themes

|  |
|:---|
| \## Self-Directed Portion Although we had done a substantial portion, I went on |
| \## Skills Showcased |
